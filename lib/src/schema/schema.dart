...
class Schema {
  ...
  static Future<void> table(String tableName, Function(Blueprint) callback) async {
  ...
  static Future<List<Map<String, dynamic>>> getColumnListing(String tableName) async {
