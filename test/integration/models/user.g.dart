...
extension _$UserFieldAccess on User {
  ...
  /// Get isActive field for registration
  Field get isActiveFieldRef => _isActive;
...
mixin _$UserFields on Model<User> {
  ...
  bool? get isActive => getValue<bool>('is_active');

  /// isActive property setter
  set isActive(bool? value) => setValue('is_active', value);
  ...
  void registerFields() {
    ...
    registerField('is_active', (this as User).isActiveFieldRef);
