  ...
  group('🚀 Advanced Features Test Suite', () {
    ...
    group('🎯 Scopes Tests', () {
      ...
      test('should apply post scopes', () async {
        ...
        final publishedPosts = await Post()
            .query()
        ...
        final draftPosts = await Post().query().whereNull('published_at').get();
      ...
      test('should apply comment scopes', () async {
        ...
        final approvedComments = await Comment()
            .query()
            .where('approved', true)
            .get();
        ...
        final pendingComments = await Comment()
            .query()
    ...
    group('🔍 Complex Query Tests', () {
      test('should perform whereIn queries', () async {
        ...
        final users = await User().query().whereIn('id', [1, 2]).get();
      ...
      test('should perform whereNotIn queries', () async {
        ...
        final users = await User().query().whereNotIn('id', [1]).get();
      ...
      test('should perform whereBetween queries', () async {
        ...
        final users = await User().query().whereBetween('age', 20, 30).get();
    ...
    group('🏃‍♂️ Performance & Optimization Tests', () {
      test('should handle large datasets efficiently', () async {
        ...
        final filteredUsers = await User()
            .query()
            .where('age', '>', 30)
        ...
        print(
          '⏱️ Complex query returned ${filteredUsers.length} users in ${complexQueryTime}ms',
        );
    ...
    group('🔒 Edge Cases & Error Handling', () {
      ...
      test('should handle non-existent records', () async {
        final user = await Model.find<User>(
          99999,
          () => User(),
        ); // Non-existent ID
        expect(user, isNull);
