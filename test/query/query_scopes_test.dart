  ...
  group('Query Scopes Tests', () {
    ...
    group('Query Builder Tests', () {
      ...
      test('should support WHERE conditions', () async {
        ...
        final activeUsers = await Model.where<User>(
          () => User(),
          'active',
          true,
        ).get();
      ...
      test('should support WHERE IN conditions', () async {
        ...
        final youngUsers = await Model.whereIn<User>(() => User(), 'age', [
          25,
          30,
        ]).get();
      ...
      test('should support ORDER BY clauses', () async {
        ...
        // Test ORDER BY ASC
        final usersByAge = await Model.orderBy<User>(
          () => User(),
          'age',
          'ASC',
        ).get();
        ...
        // Test ORDER BY DESC
        final usersByAgeDesc = await Model.orderBy<User>(
          () => User(),
          'age',
          'DESC',
        ).get();
      ...
      test('should support complex queries', () async {
        ...
        final complexQuery = await Model.query<User>(
          () => User(),
        ).where('age', '>', 22).orderBy('age').limit(2).get();
    ...
    group('Local Scopes Tests', () {
      ...
      test('should apply scopes using Model.scope', () async {
        ...
        // Test active scope
        final activeUsers = await Model.scope<User>(
          () => User(),
          'active',
        ).get();
        expect(activeUsers, hasLength(1));
      ...
      test('should chain scopes with query builder methods', () async {
        ...
        final activeAdults = await Model.scope<User>(
          () => User(),
          'active',
        ).where('age', '>=', 18).get();
    ...
    group('Query Builder Methods Tests', () {
      test('should support first() method', () async {
        ...
        // Test first() method
        final firstUser = await Model.query<User>(
          () => User(),
        ).orderBy('age').first();
      ...
      test('should support count() method', () async {
        ...
        final adultCount = await Model.query<User>(
          () => User(),
        ).where('age', '>=', 23).count();
      ...
      test('should support exists() method', () async {
        ...
        final hasOldUsers = await Model.query<User>(
          () => User(),
        ).where('age', '>', 50).exists();
      ...
      test('should support when() conditional method', () async {
        ...
        final users = await Model.query<User>(
          () => User(),
        ).when(filterByAge, (query) => query.where('age', '>=', 18)).get();
        ...
        filterByAge = false;
        final allUsers = await Model.query<User>(
          () => User(),
        ).when(filterByAge, (query) => query.where('age', '>=', 18)).get();
    ...
    group('Helper Scope Functions Tests', () {
      ...
      test('should use dateRangeScope helper', () async {
        ...
        final dateScope = dateRangeScope<User>(
          'created_at',
      ...
      test('should use recentScope helper', () async {
        ...
        final recentScopeFunction = recentScope<User>(
          'created_at',
          Duration(days: 1),
        );
        final queryBuilder = Model.query<User>(() => User());
