...
class User extends Model<User> {
  ...
  Future<Profile?> profile() async => await hasOne<Profile>(() => Profile()).get();
}
...
class Post extends Model<Post> {
  ...
  Future<List<Comment>> comments() async => await hasMany<Comment>(() => Comment()).get();
}
  ...
  group('Relationship Tests', () {
    ...
    group('Relationship Registry Tests', () {
      ...
      test('should use short API for type-safe relationship access', () async {
        ...
        user.registerRelationship('profile', user.hasOne<Profile>(() => Profile()));
      ...
      test('should throw error for non-existent relationships in short API', () async {
        final user = User();
